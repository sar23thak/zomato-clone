...
class TomatoApp{
    public:
        ...
        {
            auto restaurant1=new Restaurant("Bikaner", "Delhi");
            restaurant1->addMenuItem(MenuItem("P1", "Chole Bhature", 120));
            restaurant1->addMenuItem(MenuItem("P2", "Samosa", 60));
            restaurant1->addMenuItem(MenuItem("P3", "Momos", 100));
        ...
        vector<Restaurant*> searchRestaurants(const string& loc)
        {
            return RestaurantManager::getInstance()->searchByLocation(loc);
        }
